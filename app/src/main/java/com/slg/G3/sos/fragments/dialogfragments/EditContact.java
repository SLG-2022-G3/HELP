...
public class EditContact extends DialogFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_edit_contact, container);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        //Get field from view
        etName = (EditText) view.findViewById(R.id.etContactName);
        etNumber = (EditText) view.findViewById(R.id.etContactNumber);
